...
set.seed(123)
resSEN.init <- Mixt.fit.init(X=X, k=4, density = "MSEN", ncores = ncores, verbose = TRUE, nstartR = 50)
resSEN <- Mixt.fit(X=X, k = 4, init.par = resSEN.init, density = "MSEN", ncores = nThreads, verbose = T)
...
set.seed(123)
resTIN.init <- Mixt.fit.init(X=X, k=4, density = "MTIN", ncores = ncores, verbose = TRUE, nstartR = 50)
resTIN <- Mixt.fit(X=X, k = 4, init.par = resTIN.init, density = "MTIN", ncores = nThreads, verbose = T)
